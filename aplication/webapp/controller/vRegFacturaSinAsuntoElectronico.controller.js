...
function (Controller,MessageBox,MessageToast,JSONModel) {
    ...
    return Controller.extend("adp.aplication.controller.vRegFacturaSinAsuntoElectronico", {
        ...
        _dgSinAsuntoDocumentos: function () { 
            var e = this.getView();
            if (!this.dgSinAsuntoDocumentos) { this.dgSinAsuntoDocumentos = sap.ui.xmlfragment("idDgSinAsuntoDocumentos01", "spm.aplication.view.fragments.dgSinAsuntoDocumentos", this) };
        ...
        btn_AddDocs: function () { 
			let fragment = "idDgSinAsuntoDocumentos01"; 
