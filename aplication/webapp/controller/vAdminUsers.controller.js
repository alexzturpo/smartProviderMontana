...
function (Controller) {
    ...
    return Controller.extend("spm.aplication.controller.vAdminUsers", {
        getRouter: function () {
        ...
        _dgAddUsuario: function () { 
            var e = this.getView();
            if (!this.dgAddUsuario) { this.dgAddUsuario = sap.ui.xmlfragment("idDgAddUsuario", "spm.aplication.view.fragments.adminUser.dgAddUsuario", this) };
        ...
        _dgEditUsuario: function () { 
            var e = this.getView();
            if (!this.dgEditUsuario) { this.dgEditUsuario = sap.ui.xmlfragment("idDgEditUsuario", "spm.aplication.view.fragments.adminUser.dgEditUsuario", this) };
        ...
        _dgAssignEmpresa: function () { 
            var e = this.getView();
            if (!this.dgAssignEmpresa) { this.dgAssignEmpresa = sap.ui.xmlfragment("idDgAssignEmpresa", "spm.aplication.view.fragments.adminUser.dgAssignEmpresa", this) };
        ...
        _dgAssignProveedor: function () { 
            var e = this.getView();
            if (!this.dgAssignProveedor) { this.dgAssignProveedor = sap.ui.xmlfragment("idDgAssignProveedor", "spm.aplication.view.fragments.adminUser.dgAssignProveedor", this) };
        ...
        _dgAddEmpresa: function () { 
            var e = this.getView();
            if (!this.dgAddEmpresa) { this.dgAddEmpresa = sap.ui.xmlfragment("idDgAddEmpresa", "spm.aplication.view.fragments.adminUser.dgAddEmpresa", this) };
        ...
        _dgAddProveedor: function () { 
            var e = this.getView();
            if (!this.dgAddProveedor) { this.dgAddProveedor = sap.ui.xmlfragment("idDgAddProveedor", "spm.aplication.view.fragments.adminUser.dgAddProveedor", this) };
