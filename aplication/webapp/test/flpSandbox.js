		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Provider Montana",
									"targetURL": "#spmaplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"spmaplication-display": {
								"semanticObject": "spmaplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=spm.aplication",
									"url": sap.ui.require.toUrl("spm/aplication")
								}
							}
						}
					}
